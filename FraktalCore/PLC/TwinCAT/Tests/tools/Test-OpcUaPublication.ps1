param(
    [string]$PlcRoot = (Split-Path -Parent (Split-Path -Parent $PSScriptRoot))
)
...
$topologyFile = Join-Path $PlcRoot 'Examples\Fraktal_Press_Demo\01_PneumaticPress\Io\GVL_PressFieldbus.TcGVL'
