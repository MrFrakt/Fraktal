...
.DESCRIPTION
    Specification/Guides/TWINCAT_XAE_WORKFLOW.md 4.1/4.2 describes this as an XAE GUI
...
.EXAMPLE
    ...
    ./FraktalCore/PLC/TwinCAT/tools/Invoke-TwinCatLibraryInstall.ps1 -Library Fraktal_Core
#>
[CmdletBinding()]
param(
        ...
        try {
            ...
            if (-not $iecProject.CheckAllObjects()) {
                throw ("CheckAllObjects returned FALSE for $name; nothing was installed. " +
                       "Run FraktalCore/PLC/TwinCAT/tools/Invoke-TwinCatBuild.ps1 for the DTE2 error rows.")
            }
