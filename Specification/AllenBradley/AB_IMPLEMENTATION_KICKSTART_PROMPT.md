...
3. `Specification/AllenBradley/ALLEN_BRADLEY_PORT_PLAN.md`
4. `Specification/Fraktal_AB_Part_III.md`, especially AB §0, R0–R6, every
   `[PROVISIONAL Sn]` clause, AB §3.1–§3.5, §5 and §12
5. `Specification/AllenBradley/AB_IMPLEMENTATION_PLAN.md`
6. `Specification/AllenBradley/AB_ENGINEERING_INTERFACE_AND_TOOL_CATALOG.md`
7. `Specification/AllenBradley/AB_ENGINEERING_WORKSTATION_ACCESS_RUNBOOK.md`
8. `Specification/AllenBradley/Evidence/AB_S1_CIP_DATA_PATH_EVIDENCE.md`,
   `Specification/AllenBradley/Evidence/AB_S2_AOI_PARAMETER_EVIDENCE.md`, and
   `Specification/AllenBradley/Evidence/AB_PHASE0_PHYSICAL_EXECUTION_EVIDENCE.md`
...
11. `Specification/Guides/FIRST_PROJECT_AGENT_GUIDE.md` for phase/evidence discipline
